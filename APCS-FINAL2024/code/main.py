...
class Main:
	def __init__(self):
		...
		# audio 
		self.crunch_sound = pygame.mixer.Sound(join('..', 'audio', 'intake.mp3'))
		self.bg_music = pygame.mixer.Sound(join('..', 'audio', 'ambient.mp3'))
	...
	def collision(self):
		...
		if self.snake.body[0] in self.snake.body[1:] or \
			...
			self.snake.body[0] == self.bomb.pos or \
